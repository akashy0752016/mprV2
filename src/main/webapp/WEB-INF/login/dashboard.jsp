                        ...
                        <table class="table table-bordered table-striped table-hover text-center">
                                ...
                                <td>                                                
                                    <div class="list-contacts list-contacts-inline" style="width: 160px;">
                                        <a href="#" class="list-contacts-item contact-online">
                                            <img src="<c:url value="/resources/assets/images/users/user_2.jpg" />"> Devin Stephens
                                        </a>
                                    </div>
                                </td>
                                ...
                                <td>                                                
                                    <div class="list-contacts list-contacts-inline" style="width: 160px;">
                                        <a href="#" class="list-contacts-item contact-away">
                                            <img src="<c:url value="/resources/assets/images/users/user_3.jpg" />"> Marissa George
                                        </a>
                                    </div>
                                </td>
                                <td class="text-left table-products">
                                ...
                                <td>
                                    <div class="list-contacts list-contacts-inline" style="width: 160px;">
                                        <a href="#" class="list-contacts-item contact-offline">
                                            <img src="<c:url value="/resources/assets/images/users/user_1.jpg" />"> John Doe
                                        </a>
                                    </div>                                                
                                </td>
                                <td class="text-left table-products">
                            ...
                            <tr>             
                                <td>
                                    <div class="list-contacts list-contacts-inline" style="width: 160px;">
                                        <a href="#" class="list-contacts-item contact-offline">
                                            <img src="<c:url value="/resources/assets/images/users/user_4.jpg" />"> Karen Spencer
                                        </a>
                                    </div>                                                 
                                </td>
                                <td class="text-left table-products">
